...
import { SCROLL_COOLDOWN_MS } from './layout'
...
// ---------------------------------------------------------------------------
// Event type resolution (same pattern as snake/weather)
// ---------------------------------------------------------------------------
...
export function onEvenHubEvent(event: EvenHubEvent): void {
  ...
  appendEventLog(`RESOLVED: type=${String(eventType)} screen=${state.screen} animating=${state.animating}`)
